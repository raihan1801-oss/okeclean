...
type Model = PrismaClient['delivery'];
type History = PrismaClient['deliveryHistory'];

export type Data = Delivery;
...
export type GetQuery = Prisma.DeliveryFindUniqueArgs;
export type SearchQuery = Prisma.DeliveryFindFirstArgs;
export type SearchManyQuery = Prisma.DeliveryFindManyArgs;
export type CreateQuery = Prisma.DeliveryCreateArgs;
export type CreateManyQuery = Prisma.DeliveryCreateManyArgs;
export type UpdateQuery = Prisma.DeliveryUpdateArgs;
export type UpdateManyQuery = Prisma.DeliveryUpdateManyArgs;
export type UpsertQuery = Prisma.DeliveryUpsertArgs;
export type DeleteQuery = Prisma.DeliveryDeleteArgs;
export type DeleteManyQuery = Prisma.DeliveryDeleteManyArgs;
export type AggregateQuery = Prisma.DeliveryAggregateArgs;
export type GroupQuery = ToOptional<
	Required<Prisma.DeliveryGroupByArgs>,
	'by' | 'orderBy'
>;
...
export type QueringGet<Query> = Prisma.CheckSelect<
	Query,
	Data,
	Prisma.DeliveryGetPayload<Query>
>;
export type QueringSearch<Query> = HasReject<Query> extends true
	? Prisma.CheckSelect<Query, Data, Prisma.DeliveryGetPayload<Query>>
	: Prisma.CheckSelect<Query, Data, Prisma.DeliveryGetPayload<Query>> | null;
export type QueringSearchMany<Query> = Prisma.CheckSelect<
	Query,
	Array<Data>,
	Array<Prisma.DeliveryGetPayload<Query>>
>;
export type QueringCreate<Query> = Prisma.CheckSelect<
	Query,
	Prisma.Prisma__DeliveryClient<Data>,
	Prisma.Prisma__DeliveryClient<Prisma.DeliveryGetPayload<Query>>
>;
...
export type QueringUpsert<Query> = Prisma.CheckSelect<
	...
	Prisma.Prisma__DeliveryClient<Prisma.DeliveryGetPayload<Query>>
>;
export type QueringAggregate<Query> = Prisma.GetDeliveryAggregateType<Query>;
export type QueringGroup<Query extends GroupQuery> =
	Prisma.GetDeliveryGroupByPayload<Query>;
...
interface RecordParams {
	operation: Operation;
	query: object;
	result: Prisma.Prisma__DeliveryClient<Delivery>;
}
...
export class DeliveryModel {
	public model: Model;
	public history: DeliveryHistoryModel;
	public info?: UserInfo;
	constructor(protected orm: PrismaClient) {
		this.model = this.orm.delivery;
		this.history = new DeliveryHistoryModel(orm);
	}
...
class DeliveryHistoryModel {
	...
	constructor(orm: PrismaClient) {
		this.model = orm.deliveryHistory;
	}
	protected upgrade(
	...
	public update({ id, data, query, user }: Params) {
		return this.model
			.findUnique({ where: { deliveryId: id }, rejectOnNotFound: true })
			.then((history) => {
	...
	public upsert({ id, data, query, user }: Params) {
		return this.model
			.findUnique({ where: { deliveryId: id } })
			.then((history) => {
				if (history) {
					return this.model.update({
						where: { id: history.id },
	...
	public delete({ id }: { id?: number }) {
		return this.model.delete({ where: { deliveryId: id } });
	}
}
