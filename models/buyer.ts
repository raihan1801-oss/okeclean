import type { PrismaClient, Prisma, Buyer, BuyerHistory } from '@prisma/client';
import type {
	ToBoolean,
	ToOptional,
	Concate,
...
type Model = PrismaClient['buyer'];
type History = PrismaClient['buyerHistory'];

export type Data = Buyer;
...
export type GetQuery = Prisma.BuyerFindUniqueArgs;
export type SearchQuery = Prisma.BuyerFindFirstArgs;
export type SearchManyQuery = Prisma.BuyerFindManyArgs;
export type CreateQuery = Prisma.BuyerCreateArgs;
export type CreateManyQuery = Prisma.BuyerCreateManyArgs;
export type UpdateQuery = Prisma.BuyerUpdateArgs;
export type UpdateManyQuery = Prisma.BuyerUpdateManyArgs;
export type UpsertQuery = Prisma.BuyerUpsertArgs;
export type DeleteQuery = Prisma.BuyerDeleteArgs;
export type DeleteManyQuery = Prisma.BuyerDeleteManyArgs;
export type AggregateQuery = Prisma.BuyerAggregateArgs;
export type GroupQuery = ToOptional<
	Required<Prisma.BuyerGroupByArgs>,
	'by' | 'orderBy'
>;
...
export type QueringGet<Query> = Prisma.CheckSelect<
	Query,
	Data,
	Prisma.BuyerGetPayload<Query>
>;
export type QueringSearch<Query> = HasReject<Query> extends true
	? Prisma.CheckSelect<Query, Data, Prisma.BuyerGetPayload<Query>>
	: Prisma.CheckSelect<Query, Data, Prisma.BuyerGetPayload<Query>> | null;
export type QueringSearchMany<Query> = Prisma.CheckSelect<
	Query,
	Array<Data>,
	Array<Prisma.BuyerGetPayload<Query>>
>;
export type QueringCreate<Query> = Prisma.CheckSelect<
	Query,
	Prisma.Prisma__BuyerClient<Data>,
	Prisma.Prisma__BuyerClient<Prisma.BuyerGetPayload<Query>>
>;
...
export type QueringUpsert<Query> = Prisma.CheckSelect<
	...
	Prisma.Prisma__BuyerClient<Prisma.BuyerGetPayload<Query>>
>;
export type QueringAggregate<Query> = Prisma.GetBuyerAggregateType<Query>;
export type QueringGroup<Query extends GroupQuery> =
	Prisma.GetBuyerGroupByPayload<Query>;
...
interface RecordParams {
	operation: Operation;
	query: object;
	result: Prisma.Prisma__BuyerClient<Buyer>;
}
...
export class BuyerModel {
	public model: Model;
	public history: BuyerHistoryModel;
	public info?: UserInfo;
	constructor(protected orm: PrismaClient) {
		this.model = this.orm.buyer;
		this.history = new BuyerHistoryModel(orm);
	}
...
class BuyerHistoryModel {
	public model: History;
	constructor(orm: PrismaClient) {
		this.model = orm.buyerHistory;
	}
	protected upgrade(history: BuyerHistory, { id, data, query, user }: Params) {
	...
	public update({ id, data, query, user }: Params) {
		return this.model
			.findUnique({ where: { buyerId: id }, rejectOnNotFound: true })
			.then((history) => {
	...
	public upsert({ id, data, query, user }: Params) {
		return this.model.findUnique({ where: { buyerId: id } }).then((history) => {
			if (history) {
				return this.model.update({
					where: { id: history.id },
					data: this.upgrade(history, { id, data, query, user }) as any,
	...
	public delete({ id }: { id: number }) {
		return this.model.delete({ where: { buyerId: id } });
	}
}
