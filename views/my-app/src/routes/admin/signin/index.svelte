...
<div transition:fade class="page p-8 bg-gray-200 dark:bg-gray-800 place-content-center">
	...
	<section
		class="max-w-lg min-w-[300px] md:min-w-[380px] min-h-[500px] max-h-[600px] p-6 grid gap-6 rounded-xl dark:bg-gray-700 dark:text-gray-100"
	>
		<div class="grid py-4">
		...
		<form on:submit|preventDefault={submit} class="form-control grid gap-12">
			...
			<button class="btn btn-block bg-primary border-0 {disable ? 'btn-disabled' : ''}" disabled={disable}>Sign in</button>
		</form>
